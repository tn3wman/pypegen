...
def nested_tee_example():
    ...
    builder.add_pipe("17.819822360 in in")
    builder.add_reducer("2")
    builder.add_pipe("21.5 in")
    builder.add_elbow("north", "bw")
    pl1 = 25.274914359 + 1.919087087
    builder.add_pipe(f"{pl1} in")
    builder.add_elbow("up", "bw")
    builder.add_pipe("13.5 in")
...
def main():
    ...
    route.export(str(step_output / "ammonia_in.step"))
    ...
    drawing = PipingDrawing(
        ...
        title='Ammonia Inlet Piping',
        drawing_number="####",
        revision="0",
        description='Ammonia Inlet Piping to MFCs',
        material="316 Stainless Steel",
        project_number="W803",
        drawn_by="T. Newman",
        show_hidden=True,
    ...
    # Export SVG and PDF
    svg_path = output_dir / "ammonia_in.svg"
    pdf_path = output_dir / "ammonia_in.pdf"
